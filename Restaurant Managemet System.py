...
def send():
    if textReceipt.get(1.0, END) == '\n':
        ...
        root2.config(bg='powder blue')
        root2.geometry('485x620+50+50')

        logoImage = PhotoImage(file='sender.png')
        label = Label(root2, image=logoImage, bg='powder blue')
        label.pack(pady=5)

        numberLabel = Label(root2, text='Mobile Number', font=('arial', 18, 'bold underline'), bg='powder blue', fg='black')
        numberLabel.pack(pady=5)

        numberfield = Entry(root2, font=('helvetica', 22, 'bold'), bd=3, width=24)
        numberfield.pack(pady=5)

        billLabel = Label(root2, text='Bill Details', font=('arial', 18, 'bold underline'), bg='powder blue', fg='black')
        ...
        sendButton = Button(root2, text='SEND', font=('arial', 19, 'bold'), bg='black', fg='powder blue', bd=7, relief=GROOVE
                            , command=send_msg)
...
def receipt():
    ...
    if costoffoodvar.get() != '' or costofcakesvar.get() != '' or costofdrinksvar.get() != '':
        ...
        if e_Pizza.get() != '0':
            textReceipt.insert(END, f'Pizza:\t\t\t{int(e_Pizza.get()) * 40}\n\n')
        ...
        if e_Chai.get() != '0':
            textReceipt.insert(END, f'Chai:\t\t\t{int(e_Chai.get()) * 50}\n\n')
...
topFrame = Frame(root, bd=10, relief=RIDGE, bg='powder blue')
topFrame.pack(side=TOP)

labelTitle = Label(topFrame, text='Restaurant Management System', font=('arial', 30, 'bold'), fg='black', bd=9,
                   bg='powder blue', width=51)
labelTitle.grid(row=0, column=0)

# frames

menuFrame = Frame(root, bd=10, relief=RIDGE, bg='powder blue')
menuFrame.pack(side=LEFT)

costFrame = Frame(menuFrame, bd=4, relief=RIDGE, bg='powder blue', pady=10)
...
rightFrame = Frame(root, bd=15, relief=RIDGE, bg='powder blue')
rightFrame.pack(side=RIGHT)

calculatorFrame = Frame(rightFrame, bd=1, relief=RIDGE, bg='powder blue')
calculatorFrame.pack()

recieptFrame = Frame(rightFrame, bd=4, relief=RIDGE, bg='powder blue')
recieptFrame.pack()

buttonFrame = Frame(rightFrame, bd=3, relief=RIDGE, bg='powder blue')
buttonFrame.pack()
...
Burger = Checkbutton(foodFrame, text='Burger', font=('arial', 18, 'bold'), onvalue=1, offvalue=0, variable=var3
                   , command=Burger)
...
Pizza = Checkbutton(foodFrame, text='Pizza', font=('arial', 18, 'bold'), onvalue=1, offvalue=0, variable=var5
                    , command=Pizza)
...
Noodles = Checkbutton(foodFrame, text='Noodles', font=('arial', 18, 'bold'), onvalue=1, offvalue=0, variable=var7,
                     command=Noodles)
...
Dosa = Checkbutton(foodFrame, text='Dosa', font=('arial', 18, 'bold'), onvalue=1, offvalue=0, variable=var9
                      , command=Dosa)
Dosa.grid(row=8, column=0, sticky=W)
...
textDosa.grid(row=8, column=1)

# Drinks

Chai = Checkbutton(drinksFrame, text='Chai', font=('arial', 18, 'bold'), onvalue=1, offvalue=0, variable=var10
                    , command=Chai)
...
labelCostofFood = Label(costFrame, text='Cost of Food', font=('arial', 16, 'bold'), bg='powder blue', fg='black')
...
labelCostofDrinks = Label(costFrame, text='Cost of Drinks', font=('arial', 16, 'bold'), bg='powder blue', fg='black')
...
labelCostofCakes = Label(costFrame, text='Cost of Cakes', font=('arial', 16, 'bold'), bg='powder blue', fg='black')
...
labelSubTotal = Label(costFrame, text='Sub Total', font=('arial', 16, 'bold'), bg='powder blue', fg='black')
labelSubTotal.grid(row=0, column=2)

textSubTotal = Entry(costFrame, font=('arial', 16, 'bold'), bd=6, width=14, state='readonly', textvariable=subtotalvar)
textSubTotal.grid(row=0, column=3, padx=41)

labelServiceTax = Label(costFrame, text='Service Tax', font=('arial', 16, 'bold'), bg='powder blue', fg='black')
...
labelTotalCost = Label(costFrame, text='Total Cost', font=('arial', 16, 'bold'), bg='powder blue', fg='black')
...
buttonTotal = Button(buttonFrame, text='Total', font=('arial', 14, 'bold'), fg='black', bg='powder blue', bd=3, padx=5,
                     command=totalcost)
buttonTotal.grid(row=0, column=0)

buttonReceipt = Button(buttonFrame, text='Receipt', font=('arial', 14, 'bold'), fg='black', bg='powder blue', bd=3, padx=5
                       , command=receipt)
buttonReceipt.grid(row=0, column=1)

buttonSave = Button(buttonFrame, text='Save', font=('arial', 14, 'bold'), fg='black', bg='powder blue', bd=3, padx=5
                    , command=save)
buttonSave.grid(row=0, column=2)

buttonSend = Button(buttonFrame, text='Send', font=('arial', 14, 'bold'), fg='black', bg='powder blue', bd=3, padx=5,
                    command=send)
buttonSend.grid(row=0, column=3)

buttonReset = Button(buttonFrame, text='Reset', font=('arial', 14, 'bold'), fg='black', bg='powder blue', bd=3, padx=5,
                     command=reset)
...
button7 = Button(calculatorFrame, text='7', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6,
                 command=lambda: buttonClick('7'))
button7.grid(row=1, column=0)

button8 = Button(calculatorFrame, text='8', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6,
                 command=lambda: buttonClick('8'))
button8.grid(row=1, column=1)

button9 = Button(calculatorFrame, text='9', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6
                 , command=lambda: buttonClick('9'))
button9.grid(row=1, column=2)

buttonPlus = Button(calculatorFrame, text='+', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6
                    , command=lambda: buttonClick('+'))
buttonPlus.grid(row=1, column=3)

button4 = Button(calculatorFrame, text='4', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6
                 , command=lambda: buttonClick('4'))
button4.grid(row=2, column=0)

button5 = Button(calculatorFrame, text='5', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6
                 , command=lambda: buttonClick('5'))
button5.grid(row=2, column=1)

button6 = Button(calculatorFrame, text='6', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6
                 , command=lambda: buttonClick('6'))
button6.grid(row=2, column=2)

buttonMinus = Button(calculatorFrame, text='-', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6
                     , command=lambda: buttonClick('-'))
buttonMinus.grid(row=2, column=3)

button1 = Button(calculatorFrame, text='1', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6
                 , command=lambda: buttonClick('1'))
button1.grid(row=3, column=0)

button2 = Button(calculatorFrame, text='2', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6
                 , command=lambda: buttonClick('2'))
button2.grid(row=3, column=1)

button3 = Button(calculatorFrame, text='3', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6
                 , command=lambda: buttonClick('3'))
button3.grid(row=3, column=2)

buttonMult = Button(calculatorFrame, text='*', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6
                    , command=lambda: buttonClick('*'))
buttonMult.grid(row=3, column=3)

buttonAns = Button(calculatorFrame, text='Ans', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6,
                   command=answer)
buttonAns.grid(row=4, column=0)

buttonClear = Button(calculatorFrame, text='Clear', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6
                     , command=clear)
buttonClear.grid(row=4, column=1)

button0 = Button(calculatorFrame, text='0', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6
                 , command=lambda: buttonClick('0'))
button0.grid(row=4, column=2)

buttonDiv = Button(calculatorFrame, text='/', font=('arial', 16, 'bold'), fg='black', bg='powder blue', bd=6, width=6,
                   command=lambda: buttonClick('/'))
